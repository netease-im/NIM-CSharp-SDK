...
namespace NIM
{
    namespace NIMRts
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void NimRtsAckResCbFunc(int code, 
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))] string sessionId, int channelType,
