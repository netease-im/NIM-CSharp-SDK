...
namespace NIM.Messagelog
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntPtr _ExportBackupToRemotePackageCallback_C([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string file_path, IntPtr user_data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntPtr _ExportBackupToRemoteEncryptCallback_C([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string file_path,
         [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string encrypt_key, IntPtr user_data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void _LogsBackupProgressCallback(LogsBackupRemoteOperate param0, float param1, IntPtr user_data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void _LogsBackupCompleteCallback(LogsBackupRemoteOperate param0, LogsBackupRemoteState param1, IntPtr user_data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool _ExportBackupToRemoteLogFiter([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string msg, IntPtr user_data);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void _NewPathRelease(ref IntPtr param0);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntPtr _ImportBackupFromRemoteUnPackageCallback_C([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))]string file_path, IntPtr user_data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntPtr _ImportBackupFromRemoteDecryptCallback_C([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))]string file_path,
        [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string encrypt_key, IntPtr user_data);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void DeleteOnlineHistoryResultDelegate(int res_code,
        [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string account_id,
        IntPtr user_data);


    [StructLayout(LayoutKind.Sequential)]
    public struct NIMLogsBackupExportInfo_C
    {
        public _ExportBackupToRemotePackageCallback_C ToRemotePackageCallback_;

        public _ExportBackupToRemoteEncryptCallback_C ToRemoteEncryptCallback_;

        public IntPtr encrypt_key_;

        public _LogsBackupProgressCallback ProgressCallback_;

        public _LogsBackupCompleteCallback CompleteCallback_;

        public _ExportBackupToRemoteLogFiter ToRemoteLogFiter_;

        public _NewPathRelease PathRelease_;

        public IntPtr user_data_;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct NIMLogsBackupImportInfo_C
    {
        public _ImportBackupFromRemoteUnPackageCallback_C UnPackageCallback_;

        public _ImportBackupFromRemoteDecryptCallback_C RemoteDecryptCallback_;
    ...
    class MsglogNativeMethods
    {
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool nim_msglog_query_receipt_sent(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string json_msg,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))]string json_extension);


        [DllImport(NIM.NativeConfig.NIMNativeDLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool nim_export_backup_to_remote(ref NIMLogsBackupExportInfo_C export_info);

        [DllImport(NIM.NativeConfig.NIMNativeDLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool nim_import_backup_from_remote(ref NIMLogsBackupImportInfo_C import_info);

        [DllImport(NIM.NativeConfig.NIMNativeDLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool nim_cancel_import_backup_from_remote();

        [DllImport(NIM.NativeConfig.NIMNativeDLL, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool nim_cancel_export_backup_to_remote();
